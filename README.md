This project is [![powered by naptha.ai](https://dl.naptha.ai/fbn.svg)](https://naptha.ai?utm_source=github&utm_medium=badge&utm_campaign=powered_by&utm_content=KoNit-K%2FRedTeamingAgent.git)
...
```sh
poetry run python RedTeamingAgent/run.py
```
